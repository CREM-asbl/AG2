...
Inherits Circle
	#tag Method, Flags = &h0
		Sub StdCircle(ol as objectsList, fam as integer, form as integer, p as BasicPoint)
	...
	#tag Method, Flags = &h0
		Sub StdCircle(ol as objectslist, p as basicpoint, s as stdcircle)
		  Shape(ol,s)
	...
	#tag Method, Flags = &h0
		Sub StdCircle(ol as objectsList, El as XMLElement)
