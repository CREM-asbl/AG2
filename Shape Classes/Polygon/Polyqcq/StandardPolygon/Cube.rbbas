...
Inherits StandardPolygon
	...
	#tag Method, Flags = &h0
		Sub Cube(ol as ObjectsList, El as XMLElement)
		  dim name as string
		  dim sc as double
	...
	#tag Method, Flags = &h0
		Sub Cube(obl as objectslist, other as cube, p as basicPoint)
		  dim M as Matrix
		  dim sc as double
		  dim i as integer
	...
	#tag Method, Flags = &h0
		Sub Cube(ol as Objectslist, p as BasicPoint, m as integer)
