...
Inherits AffinityMatrix
	...
	#tag Method, Flags = &h0
		Sub Constructor(ep as Basicpoint, np as basicPoint, p1 as Point, p2 as point)
	...
	#tag Method, Flags = &h0
		Sub Constructor(c as basicpoint, k as double, a as double)
		  if c <> nil then
	...
	#tag Method, Flags = &h0
		Sub Constructor(p1 as Point, p2 as point, ep as Basicpoint, np as basicPoint)
