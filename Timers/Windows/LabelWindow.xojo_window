...
#tag WindowCode
	...
	#tag Event
		Sub Open()
		  ...
		  if lab <> nil then
		    fixe.value = lab.LockBottom and lab.LockRight
		  end if
	...
	#tag Event
		Sub Action()
		  ...
		  If OldLab <> nil then
		    ...
		    Lab.Italic = OldLab.Italic
		    Lab.LockBottom = OldLab.LockBottom
		    Lab.LockRight = OldLab.LockRight
